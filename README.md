...
> Lite memory forensics teaching toolkit

**Author:** zAx4hub

## Problem

Lite memory forensics teaching toolkit. Teams often rely on closed SaaS, brittle scripts, or untested prototypes for this niche.

## Solution

`memory-forensics-lite` is an installable TypeScript/Node toolkit by **zAx4hub** with a real **crypto** engine, CLI, examples, and tests.
